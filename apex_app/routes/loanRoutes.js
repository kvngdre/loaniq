...
router.get(
  '/',
  verifyToken,
  verifyRole(['lender', 'admin', 'credit', 'loanAgent']),
  async (req, res) => {
...
router.get(
  '/:id',
  verifyToken,
  verifyRole(['admin', 'credit', 'loanAgent']),
  async (req, res) => {
    // TODO: add all
...
router.post(
  '/create-loan-request',
  verifyToken,
  verifyRole(['admin', 'loanAgent', 'guest']),
  async (req, res) => {
