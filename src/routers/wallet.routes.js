...
router.post(
  '/',
  [verifyJWT, grantAccess(SUPER_ADMIN)],
...
router.get(
  '/:tenantId',
  [verifyJWT, validateObjectId, grantAccess('all')],
  WalletController.getWallet,
);

router.get(
  '/:tenantId/balance',
  [verifyJWT, grantAccess('all')],
  WalletController.getBalance,
);

router.patch(
  '/:tenantId',
  [verifyJWT, validateObjectId, grantAccess(SUPER_ADMIN)],
